 ...
 *  @author  Sources: N/A
 */
public class Tropius extends Monster
{
    Position p;
    public final int attack = 50;
    public int hp = 100;
    public final int xp = 50;
    GreenfootImage tropius = new GreenfootImage("tropiusbig.png");
     /**
     * Constructor to create the Tropius monster at a certain 
     * position in the map. 
     * @param x is the x coordinate
     * @param y is the y coordinate
     */
    public Tropius(int x, int y)
    {
        p = new Position(x,y);
    ...
    /**
     * Act - do whatever the Tropius wants to do. This method is called whenever
